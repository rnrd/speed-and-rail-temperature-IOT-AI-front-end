...
const TempChart=(props)=> {
    ...
    //TempChart is a child component of dashboard.
    //TempChart does not use redux states.
    ...
    const chartAxisY=()=>{
        for(let i=0;i<5;i++){
            graphData.push(props.systemData[i].temperature);
        }
    ...
    return (
        <div>
            <Container className="TemperatureChart-container">
                <Line
                data={chartState}
